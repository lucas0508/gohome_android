...
public class MaterialSpinner extends AppCompatTextView {
    ...
    /**
     * @return the selected item_quotaion_title position
     */
    ...
    /**
     * Set the default spinner item_quotaion_title using its index
     * 初始界面 常用
     *
     * @param position the item_quotaion_title's position
     */
     ...
     * @param <T>   The item_quotaion_title type
     */
    ...
    /**
     * Interface definition for a callback to be invoked when an item_quotaion_title in this view has been selected.
     *
     * @param <T> Adapter item_quotaion_title type
     */
    public interface OnItemSelectedListener<T> {

        /**
         * <p>Callback method to be invoked when an item_quotaion_title in this view has been selected. This callback is invoked only when
         * the newly selected position is different from the previously selected position or if there was no selected
         * item_quotaion_title.</p>
         *
         * @param view     The {@link MaterialSpinner} view
         * @param position The position of the view in the adapter
         * @param id       The row id of the item_quotaion_title that is selected
         * @param item     The selected item_quotaion_title
         */
        void onItemSelected(MaterialSpinner view, int position, long id, T item);
    }

    /**
     * Register a callback to be invoked when an item_quotaion_title in the dropdown is selected.
     *
    ...
    /**
     * Interface definition for a callback to be invoked when the dropdown is dismissed and no item_quotaion_title was selected.
     */
    public interface OnNothingSelectedListener {

        /**
         * Callback method to be invoked when the {@link PopupWindow} is dismissed and no item_quotaion_title was selected.
         *
    ...
    /**
     * Register a callback to be invoked when the {@link PopupWindow} is shown but the user didn't select an item_quotaion_title.
     *
