package com.qujiali.jiaogegongren.common.model.address;
...
public class Address2PickerView extends RelativeLayout implements View.OnClickListener {
    ...
    public Address2PickerView(Context context, int defaultTabCount) {
        super(context);
        init(context);
    }

    public Address2PickerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public Address2PickerView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
            ...
            if (mSelectProvice != null && mSelectCity != null) {
                ...
                if (mOnAddressPickerSureListener != null) {
                    ...
                    if (mSelectDistrict != null) {
                       // district = mSelectDistrict.getI();
                      //  districtName = mSelectDistrict.getN();
                    } else {
                       // districtName = mSelectCity.getN();
                       // district = mSelectCity.getI().substring(0, 3);
                    }
                    mOnAddressPickerSureListener.onSureClick(null, mSelectCity.getN(), mSelectProvice.getI(), mSelectCity.getI(), district);
                }
            } else {
            ...
            if (mSelectProvice != null && mSelectCity != null && mSelectDistrict != null) {
                ...
                if (mOnAddressPickerSureListener != null) {
                    ...
                    mOnAddressPickerSureListener.onSureClick(
                            mSelectProvice.getN() + " " + mSelectCity.getN() + " " + mSelectDistrict.getN() + " ",
                            mSelectDistrict.getN() + " ",
                            mSelectProvice.getI(),
                            mSelectCity.getI(),
                            mSelectDistrict.getI());
                }
            } else {
                Toast.makeText(mContext, "地址还没有选完整哦", Toast.LENGTH_SHORT).show();
            }
    ...
    public interface OnAddressPickerSureListener {
        void onSureClick(String allAddress, String address, String provinceCode, String cityCode, String districtCode);
    }
    ...
    public void setOnAddressPickerSure(OnAddressPickerSureListener listener, boolean isSelect) {
        this.mOnAddressPickerSureListener = listener;
