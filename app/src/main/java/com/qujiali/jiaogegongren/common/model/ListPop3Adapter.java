...
public class ListPop3Adapter extends BaseAdapter {
    ...
    private List<AdressDataEntity.RowsBean.ChildBeanXX.ChildBeanX> list;
    private Context mContext;
    public static HashMap<Integer, Boolean> isSelected;

    public ListPop3Adapter(List<AdressDataEntity.RowsBean.ChildBeanXX.ChildBeanX> list, Context mContext) {
