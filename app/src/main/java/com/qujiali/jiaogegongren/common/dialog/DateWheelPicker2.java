 ...
 */
public class DateWheelPicker2 extends WheelPicker {
    ...
    public DateWheelPicker2(Context context) {
        this(context, null);
    }

    public DateWheelPicker2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DateWheelPicker2(Context context, AttributeSet attrs, int defStyleAttr) {
...
//                }
        ...
        setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(WheelPicker parentView, int[] position) {
                ...
                if (mOnDateChangedListener != null) {
                    mOnDateChangedListener.onDateChanged(DateWheelPicker2.this,
    ...
    public interface OnDateChangedListener {
         ...
         */
        void onDateChanged(DateWheelPicker2 view, int year, int monthOfYear, int dayOfMonth);
    }
}
