...
import com.qujiali.jiaogegongren.common.utils.ToastUtil;
import com.qujiali.jiaogegongren.common.utils.ToastUtils;
import com.qujiali.jiaogegongren.ui.other.view.AndroidOPermissionActivity;
...
public class AppDownloadManager {
    ...
    public void downloadApk(String apkUrl, String title, String desc) {
        ...
        request.setDestinationInExternalFilesDir(weakReference.get(), Environment.DIRECTORY_DOWNLOADS, "享挣钱.apk");
    ...
    private void updateView() {
        ...
        Logger.e(TAG, "下载进度：" + bytesAndStatus[0] + "/" + bytesAndStatus[1] + "");
    }
    ...
    class DownloadReceiver extends BroadcastReceiver {
        ...
        public void onReceive(final Context context, final Intent intent) {
            ...
            Logger.e("DownloadReceiver","广播");
            // 兼容Android 8.0
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {

                //先获取是否有安装未知来源应用的权限
                haveInstallPermission = context.getPackageManager().canRequestPackageInstalls();
                Logger.e("haveInstallPermission",haveInstallPermission+"");
                if (!haveInstallPermission) {//没有权限
                    // 弹窗，并去设置页面授权
                    final AndroidOInstallPermissionListener listener = new AndroidOInstallPermissionListener() {
                        @Override
                        public void permissionSuccess() {
                            Logger.e("haveInstallPermission","permissionSuccess 1");
                            installApk(context, intent);
                            Logger.e("haveInstallPermission","permissionSuccess 2");
                        }

                        @Override
                        public void permissionFail() {
//                            ToastUtils.shortToast(context, "授权失败，无法安装应用");
                            ToastUtils.showTextToas(context,"授权失败，无法安装应用");
                        }
                    };
        ...
        if (completeDownLoadId == mReqId) {
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) { // 6.0以下
                ...
                uri = FileProvider.getUriForFile(context,
                        "com.qujiali.sharemakingmoney",
                        new File(context.getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS), "享挣钱.apk"));
                intentInstall.addFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION | Intent.FLAG_GRANT_WRITE_URI_PERMISSION);
            }

            // 安装应用
            LogUtil.e("zhouwei", "下载完成了");
