...
public class VersionUpdateDialog {
     ...
     * 显示提示更新对话框
     */
    public void showNoticeDialog(String version, String status, final String url) {
        builder = new AlertDialog.Builder(mContext);
        builder.setTitle("检测到新版本！");
        builder.setMessage("叫个工人更新咯\n优化了App各项功能，提高用户体验");
        Logger.d(version);
    ...
    private void positivebtn(final String url, AlertDialog.Builder builder) {
        builder.setPositiveButton("下载", (dialog, which) -> {
            ...
            appDownloadManager.downloadApk(url, "叫个工人", "优化了App各项功能，提高用户体验");
        });
    }
}
