...
public class SkillIntroductionActivity extends BaseActivity implements ISkillIntroductionView, IUploadFileView {
    ...
    protected void initView() {
        ...
        tv_introduction.setText("技能介绍");

        et_content.setHint("请输入技能介绍详情......");
        initGridView();
    ...
    private void goSendServerData(String imageString) {
        Map<String, Object> objectMap = new HashMap<>();
        objectMap.put("skillsIntroduce", et_content.getText().toString().trim());
        objectMap.put("skillsImages", imageString);
        skillIntroductionPresenter.sendSkillIntroduction(objectMap);
    }
